...
def get_position_and_velocity_from_data(data: PositionAmplitudeData) -> Array:
    """Get the position data from PositionAmplitudeData.
    ...
    Returns:
        Array: the particle positions and velocities from the data
    """
    return data["walker_data"]["position"],data["walker_data"]["velocity"]
