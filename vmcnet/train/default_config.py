...
def get_default_vmc_config() -> Dict:
    ...
    vmc_config = {
        ...
        "clip_threshold": 5.0,
        "clip_center": "median",  # mean or median
        "nan_safe": True,
        ...
        "optimizer": {
            ...
            "racc": {
                ...
                "learning_rate": 1e-1,  # needs to be tuned with everything else
                "learning_decay_rate": 1e-4,
                # racc hyperparams
                "alpha_schedule_type":"constant",
                "alpha":1e-1, #TBD
